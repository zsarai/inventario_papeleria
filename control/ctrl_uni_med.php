...
{
	if(insert("INSERT INTO unidad_de_med_prod (desc_uni_med) VALUES ('$_POST[desc_uni_med]');"))
	{
		echo json_encode(array(
...
{
	if(update("UPDATE unidad_de_med_prod SET desc_uni_med='$_POST[desc_uni_med]' WHERE id_uni_de_med = $_POST[id_uni_de_med];"))
	{
		echo json_encode(array(
