$(document).ready(function(){
	...
	var template = '<a href="./almacen/almprueba/uploads/original/{src}" rel="cam" '
	...
	webcam.set_swf_url('./js/camara2/webcam.swf');
	webcam.set_api_url('./almacen/almprueba/upload.php');	// The upload script
	webcam.set_quality(80);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, './js/camara2/shutter.mp3');
	...
	function loadPics(){
		...
		$.getJSON('./almacen/almprueba/browse.php',{'start':start},function(r){
