...
window.webcam = {
	...
	swf_url: './js/camara2/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: './js/camara2/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : './js/camara2/shutter.mp3';
	},
